...
/** Asks another player to teleport to the sender. */
public class Tpahere_Command implements TabExecutor {

    private final Better_Admin_Commands plugin;

    public Tpahere_Command(Better_Admin_Commands plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        Msg.send(target, "&f" + self.getName() + " &7wants you to teleport to them.");
        Msg.send(target, "&a/tpaccept &7to accept or &c/tpdeny &7to deny.");
        return true;
    }
